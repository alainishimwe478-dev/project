    ...
    <div className="min-h-screen bg-gray-50 flex">
      <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-[#003A8F] text-white transition-all duration-300 fixed h-screen left-0 top-0 shadow-lg z-40`}>
        ...
        <nav className="mt-8 space-y-2 px-4">
          ...
          <Link to="/admin-ai-control" className="block px-4 py-2 rounded bg-[#F5C400] text-[#003A8F] font-semibold transition">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-4">AI Model Status</h3>
              <p className="text-sm text-gray-600 mb-4">Status: <span className="text-green-600 font-bold">Active</span></p>
              <p className="text-sm text-gray-600">Accuracy: 98.5%</p>
            </div>
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Fraud Detection</h3>
              <p className="text-sm text-gray-600 mb-4">Threats Detected: 23</p>
              <button className="px-4 py-2 bg-[#003A8F] text-white rounded hover:bg-[#002F73]">
                View Details
              </button>
            </div>
          </div>
