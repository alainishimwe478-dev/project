        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-lg font-bold text-[#003A8F] mb-2">Payment Reports</h3>
              <p className="text-gray-600 mb-4">View detailed payment analytics and trends</p>
              <button className="px-4 py-2 bg-[#F5C400] text-[#003A8F] font-semibold rounded hover:bg-[#E6B800] transition">
                View Report
              </button>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-lg font-bold text-[#003A8F] mb-2">User Activity Reports</h3>
              <p className="text-gray-600 mb-4">Track user engagement and activity metrics</p>
              <button className="px-4 py-2 bg-[#F5C400] text-[#003A8F] font-semibold rounded hover:bg-[#E6B800] transition">
                View Report
              </button>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-lg font-bold text-[#003A8F] mb-2">Fraud Detection Reports</h3>
              <p className="text-gray-600 mb-4">Monitor fraud alerts and security incidents</p>
              <button className="px-4 py-2 bg-[#F5C400] text-[#003A8F] font-semibold rounded hover:bg-[#E6B800] transition">
                View Report
              </button>
            </div>
