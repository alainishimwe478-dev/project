    ...
    <div className="min-h-screen bg-gray-50 flex">
      <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-[#003A8F] text-white transition-all duration-300 fixed h-screen left-0 top-0 shadow-lg z-40`}>
        ...
        <nav className="mt-8 space-y-2 px-4">
          ...
          <Link to="/admin-settings" className="block px-4 py-2 rounded bg-[#F5C400] text-[#003A8F] font-semibold transition">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              <div className="border-b pb-4">
                ...
                <input type="text" defaultValue="HealthPay AI" className="w-full border rounded-lg px-3 py-2" />
              </div>
              <div className="border-b pb-4">
                <label className="block text-sm font-medium text-gray-900 mb-2">Email Notifications</label>
                <input type="checkbox" defaultChecked className="w-4 h-4" />
              </div>
              <button className="px-6 py-2 bg-[#003A8F] text-white rounded-lg hover:bg-[#002F73]">
                Save Settings
              </button>
            </div>
          </div>
